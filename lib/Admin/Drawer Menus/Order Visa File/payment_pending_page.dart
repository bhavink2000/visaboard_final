...
import '../../App Helper/Search Data/Drawer Menus Search Data/search_payment_pending_data.dart';
...
class PaymentPendingPage extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return _PaymentPendingPage();
  }
}

class _PaymentPendingPage extends State<PaymentPendingPage>{
  ...
  Widget build(BuildContext context) {
    ...
    return AdvancedDrawer(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Align(alignment: Alignment.topRight,child: Text("PAYMENT PENDING",style: AllHeader)),
          elevation: 0,
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  onTap: (){
                                    showSearch(
                                      context: context,
                                      delegate: OVFPaymentSearch(context: context,access_token: getAccessToken.access_token)
                                    );
                                  },
                                ),
                              ),
