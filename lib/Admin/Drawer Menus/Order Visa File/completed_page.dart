...
import '../../App Helper/Search Data/Drawer Menus Search Data/search_ovf_completed_data.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return AdvancedDrawer(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Align(alignment: Alignment.topRight,child: Text("COMPLETE",style: AllHeader)),
          elevation: 0,
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  onTap: (){
                                    showSearch(
                                      context: context,
                                      delegate: OVFCompletedSearch(context: context,access_token: getAccessToken.access_token));
                                  },
                                ),
                              ),
                            ),
