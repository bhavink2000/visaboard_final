// ignore_for_file: missing_return, use_build_context_synchronously, must_be_immutable, prefer_typing_uninitialized_variables
...
import 'package:visaboard_final/Admin/Drawer%20Menus/Order%20Visa%20File/order_visafile_add_applicant.dart';
...
import '../../App Helper/Search Data/Drawer Menus Search Data/search_order_visafile_data.dart';
...
class _OrderVisaFile extends State<OrderVisaFile>{
                          ...
                          return AnimationLimiter(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index){
                                ...
                                for (int i = 0; i < value.orderVisaFileDataList.data!.ovfData!.data!.length; i++) {
                                      ...
                                      children: [
                                                            ...
                                                            children: <Widget>[
                                                              ...
                                                              Expandable(
                                                                collapsed: buildCollapsed3(
                                                                  ...
                                                                  index,
                                                                  orderVisaFile[index].showDropdown,
                                                                  orderVisaFile[index].statusDropdown,
                                                                    orderVisaFile[index].action!.editStatus ?? 0,
                                                                    orderVisaFile[index].action!.sendMsg4UploadDocsStatus ?? 0,
                                                                    orderVisaFile[index].action!.uploadDocsStatus ?? 0,
                                                                    orderVisaFile[index].action!.chatStatus ?? 0,
                                        ...
                                        index + 1 == orderVisaFile.length ? CustomPaginationWidget(
                                          ...
                                          onPageChange: (page) {
                                            ...
                                            drawerMenuProvider.fetchOrderVisaFile(curentindex + 1, getAccessToken.access_token, '');
                                          },
                                        ) : Container(),
                                      ],
                                    ),
  ...
  buildCollapsed3(var letter, var company, index, var showDropDown,var dropDownStatus, var edit, var msg, var upload, var chat, var subdomain ,var invoice,
      var user_id, var user_sop_id, var invoiceNm, var id,var c_id, var c_fnm, var c_lnm,var s_nm, var l_nm, var country_nm,var o_price) {
    return Column(
      children: [
        Row(
          children: [
  ...
  buildExpanded1(var edit, var msg, var upload, var chat, var subdomain ,var invoice,var user_id, var user_sop_id, var invoiceNm,
      var id,var c_id, var c_fnm, var c_lnm,var s_nm, var l_nm, var country_nm,var o_price) {
    return Container(
      color: PrimaryColorOne,
      child: Column(
        children: [
