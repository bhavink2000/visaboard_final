...
import '../../App Helper/Search Data/Drawer Menus Search Data/search_ovf_hold_data.dart';
...
class HoldPage extends StatefulWidget{
  HoldPage({Key? key}) : super(key: key);
...
class _HoldPage extends State<HoldPage>{
  ...
  Widget build(BuildContext context) {
    ...
    return AdvancedDrawer(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Align(alignment: Alignment.topRight,child: Text("Hold",style: AllHeader)),
          elevation: 0,
            ...
            Row(
              ...
              children: [
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  onTap: (){
                                    showSearch(
                                      context: context,
                                      delegate: OVFHoldSearch(context: context,access_token: getAccessToken.access_token)
                                    );
                                  },
                                ),
                              ),
                ...
                Padding(
                  ...
                  child: TextButton(
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>OVFAddApplicant()));
                    },
