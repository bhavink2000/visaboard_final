...
class OrderVisaFileSearch extends SearchDelegate{
  ...
  OrderVisaFileSearch({Key? key,this.access_token,required this.context});
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return Column(
                children: [
                                    ...
                                    children: <Widget>[
                                      Expandable(
                                        ...
                                        expanded: buildExpanded1(
                                          item['action']['edit_status'] ?? 0,
                                          item['action']['send_msg_4_upload_docs_status'] ?? 0,
                                          item['action']['upload_docs_status'] ?? 0,
                                          item['action']['chat_status'] ?? 0,
                                          item['action']['add_subdomain_status'] ?? 0,
                                          item['action']['invoice_pdf_status'] ?? 0,
                                          item['enc_user_id'],
                                          item['enc_id'],
                                          item['invoice_pdf'],
                                          item['id'],
                  ...
                  if (snapshot.data!.length == 10 || index + 1 != snapshot.data!.length)
                    Container()
                  else
                    SizedBox(height: MediaQuery.of(context).size.height / 4),

                  index + 1 == snapshot.data!.length ? CustomPaginationWidget(
