...
class OVFCompletedSearch extends SearchDelegate{
  var access_token;
  BuildContext context;
  OVFCompletedSearch({Key? key,this.access_token,required this.context});
  ...
  Future<List<dynamic>> getItemsData(var index) async {
    ...
    final body = {'search_text': query,'status_as': '1'};
